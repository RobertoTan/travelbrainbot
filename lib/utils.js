...
module.exports = {
  buildItineraryMessage: function(firstName, payload, introMessage) {
    return {
      attachment: {
        "type": "template",
        "payload": {
          ...
          "theme_color": "#00796B",
          "intro_message": introMessage || `Hi ${firstName}. One of our travel agents just made a flight booking for you.`,
          "locale": "en_US",
