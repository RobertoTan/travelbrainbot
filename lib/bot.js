...
class TravelbrainBot {
  ...
  startConversation(userId, payload) {
    payload = {
      ...
      segments: [
        ...
        },
        {
          ...
          departureAirport: 'LAX',
          arrivalAirport: 'SFO',
          departureTime: '2016-01-04T19:45',
          arrivalTime: '2016-01-04T21:20'
        }
      ],
      price: {
        amount: 245,
    ...
    this._getUserName(userId)
      ...
      .then(() => {
        this.questionnaires[userId] = AskedPermission;
        return this.sendTextMessage(userId, 'We can finalise this booking for you right now. However we\'d like to take the opportunity to learn a bit more about you and build an itinerary just for you. I will need to ask you a few questions. Is this OK? :)');
      });
  }
}
